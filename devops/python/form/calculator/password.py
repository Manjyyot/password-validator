...
def check_password_strength(password: str) -> bool:
    ...
    # Direct length validation
    if len(password) < 8:
        print("The password must be 8 characters or longer.")
        return False
    
    # Iterate over the password to validate criteria
    for character in password:
        ...
        # Early return if all conditions are satisfied without spaces
...
if __name__ == "__main__":
    # Continue prompting until a valid password is provided
    while True:
